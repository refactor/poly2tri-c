...
*/
static bool diagonalie(vidx_t im1, vidx_t ip1, vidx_t next_node[], const coord_seq_t* cs)
{
    vidx_t first = im1;
    vidx_t j = first;
...
*/
static bool in_cone(vidx_t im1, vidx_t ip1, vidx_t prev_node[], vidx_t next_node[], const coord_seq_t* cs)
{
...
MYIDEF vidx_t *polygon_triangulate(const coord_seq_t* cs)
{
    const vidx_t n = cs->n;
